...
- `apps/inference-gateway/config.example.json` — non-secret gateway routing template
...
your preferred secure method and create a new
`apps/inference-gateway/gateway.config.json`
