...
Future<void> _expectHostedCaption(int port) async {
...
Future<void> _verifyMobileBrowserSource() async {
  ...
  try {
    ...
    await _expectHostedCaption(port);
  } finally {
...
void main() {
  ...
  testWidgets(
    'serves styled captions from the iOS Simulator LAN host',
    (_) => _verifyMobileBrowserSource(),
  );
}
