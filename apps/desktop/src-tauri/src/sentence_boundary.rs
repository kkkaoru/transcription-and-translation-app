...
//!
//! Mirrors `apps/desktop/src/overlay/sentenceBoundary.ts`. Vibrato IPADIC
//! features are preferred when a tokenizer is available; otherwise AzooKey
//! copula / punctuation heuristics keep the overlay and Browser Source in
//! sync.
