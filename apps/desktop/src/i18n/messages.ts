...
const ja = {
  ...
  "sidebar.description": "日本語の音声を認識し、英語字幕をSyphon / Spout2 または透過取り込みへ送ります。",
...
const en: Record<MessageKey, string> = {
  ...
  "sidebar.description":
    "Recognize Japanese speech and send Japanese and English captions via Syphon / Spout2 or transparent capture.",
