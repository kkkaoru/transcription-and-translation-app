...
const ja = {
  ...
  "brand.caption": "音声を字幕にするツール",
  "sidebar.eyebrow": "BROADCAST CONSOLE",
  "sidebar.title": "字幕を始める",
  "sidebar.description": "マイクを選んで開始すると、日本語の音声が英語字幕になります。",
  "sidebar.menu": "メインメニュー",
  "sidebar.live": "配信",
  "sidebar.style": "文字の装飾",
  "sidebar.dictionary": "カスタム辞書",
  "sidebar.settings": "アプリ設定",
  "sidebar.privacyTitle": "ローカルファースト",
  "sidebar.privacyDetail": "音声は設定した推論先だけに送信",
  "live.eyebrow": "LIVE WORKSPACE",
  "live.title": "字幕",
  "live.lead": "マイクを選び、開始を押すと字幕が流れます。細かい調整は設定の詳細設定へ。",
  "live.openOverlay": "透過取り込みを開く ↗",
  "live.hideOverlay": "透過取り込みを隠す",
  "live.nativeAlwaysOn": "Syphon / Spout2 常時配信中",
  "live.outputToSyphon": "Syphon に出力中",
  "live.outputToSpout2": "Spout2 に出力中",
  "live.outputToTransparentWindow": "透過取り込みに出力中",
  "live.outputStatusHint": "この画面では字幕を描画しません。",
  "live.openTransparentCapture": "透過取り込みを開く ↗",
  "live.hideTransparentCapture": "透過取り込みを隠す",
  "live.openStyleEditor": "文字の装飾を開く ↗",
  "live.start": "字幕生成を開始",
  "live.stop": "停止",
  "live.startBlockedModels": "ASRモデルの準備が終わるまで開始できません",
  "live.startBlockedServices": "認識サービスが準備できるまで開始できません",
  "live.startBlockedWebSpeech": "この環境では Web Speech を開始できません",
  ...
  "live.pipelineTitle": "いまの処理",
  "live.localBadge": "ローカル",
  "live.asr": "日本語音声認識",
  "live.normalizer": "かな漢字変換",
  "live.translation": "日本語 → English",
  "live.pipelineInactive": "このモードでは未使用",
  "live.pipelineSummaryAzookey": "Parapper で音声認識し、AzooKey で漢字に直し、英語へ翻訳します。",
  "live.pipelineSummaryRaw": "Parapper の認識結果を、変換せずそのまま字幕にします。",
  "live.pipelineSummaryWebSpeech": "ブラウザの Web Speech API で音声認識します（検証用）。",
  "live.latestEyebrow": "LATEST CAPTION",
  "live.latestTitle": "直近の認識結果",
  "settings.eyebrow": "CONFIGURATION",
  "settings.title": "アプリ設定",
  "settings.lead": "よく使う項目と、細かい調整を分けています。",
  "settings.panes": "設定の種類",
  "settings.everyday": "普段の設定",
  "settings.advanced": "詳細設定",
  "settings.everydayLead":
    "配信前に確認する項目です。モデルや音声処理の細かい調整は詳細設定にあります。",
  "settings.advancedLead": "モデル、音声処理、出力の詳細です。",
  "settings.customDictionaryTitle": "カスタム辞書",
  "settings.customDictionaryDescription": "よみと単語を登録して、かな漢字変換へ反映します。",
  ...
  "customDictionary.delete": "削除",
  "customDictionary.cancel": "キャンセル",
  "customDictionary.save": "辞書を保存",
  "customDictionary.saving": "保存中…",
  "customDictionary.empty": "登録された単語はありません。",
  "customDictionary.noResults": "検索条件に一致する単語はありません。",
  "customDictionary.saved": "カスタム辞書を保存しました。",
  "customDictionary.loadFailed": "カスタム辞書を読み込めませんでした。",
  "customDictionary.saveFailed": "カスタム辞書を保存できませんでした。",
  "customDictionary.importCsv": "CSVをインポート（現在の辞書に追記）",
  "customDictionary.exportCsv": "CSVをエクスポート",
  "customDictionary.imported": "CSVから{count}件を追記しました。保存すると変換へ反映されます。",
  "customDictionary.exported": "{count}件をCSVへエクスポートしました。",
  "customDictionary.importFailed": "CSVを読み込めませんでした。よみ,単語の2列を確認してください。",
  "settings.everydayCaptureTitle": "音声と認識",
  "settings.everydayOutputTitle": "字幕の出し方",
  "settings.backendTitle": "推論先",
  "settings.save": "設定を保存",
  "settings.saving": "保存中…",
  ...
  "settings.azooSystemDictionary": "AzooKey システム辞書（カスタム）",
  "settings.azooSystemDictionaryHint":
    "ローカルの Dictionary ディレクトリ、または HTTPS の .tar.gz URL。URL はアプリデータにキャッシュされます。",
  "settings.azooSystemDictionarySource": "AzooKey システム辞書",
  "settings.azooSystemDictionarySourceHint":
    "内蔵自動取得・公式アーカイブ URL・カスタム（ローカル/HTTPS）から選べます。",
  "settings.azooSystemDictionaryBuiltin": "内蔵（初回キャプチャ時に自動取得）",
  "settings.azooSystemDictionaryOfficial": "公式 azooKey_dictionary_storage（HTTPS）",
  "settings.azooSystemDictionaryCustom": "カスタムパス / HTTPS URL",
  ...
  "settings.nativeOutputHint":
    "macOS では Syphon、Windows では Spout2 を起動します。デフォルトはオフです。オフのときは字幕表示ウィンドウを使ってください。",
  ...
  "message.overlayOpenFailed": "字幕表示ウィンドウを開けませんでした。",
  "message.transparentOpenFailed": "字幕表示ウィンドウを開けませんでした。",
  "message.styleEditorOpenFailed": "文字の装飾ウィンドウを開けませんでした。",
  "message.customDictionaryOpenFailed": "カスタム辞書ウィンドウを開けませんでした。",
  ...
  "model.azookey.label": "AzooKey Rust（辞書・内蔵）",
  "model.azookey.description":
    "AzooKeyのLOUDS辞書・連接コスト・ユーザー辞書をRustのViterbi変換器として実行します（ニューラルなし）。",
  "model.azookey.artifact": "内蔵辞書 / azooKey_dictionary_storage の Dictionary ディレクトリ",
  "model.zenzXsmall.label": "AzooKey Zenzai v3.2 xsmall",
  "model.zenzXsmall.description":
    "AzooKey公式のニューラル変換（Zenzai）。低レイテンシー向けのxsmall GGUFです。初回はモデル管理からダウンロードしてください。",
  "model.zenzSmall.label": "AzooKey Zenzai v3.2 small",
  "model.zenzSmall.description":
    "AzooKey公式のニューラル変換（Zenzai）。変換精度を優先するsmall GGUFです。初回はモデル管理からダウンロードしてください。",
  ...
  "debug.enableHint":
    "詳細設定の「デバッグ情報」を開くと、パイプライン段階（ASR / 正規化 / 翻訳）がライブ表示されます。開閉状態と詳細ログはローカルに保存され、開いたまま検証できます。",
  "debug.refresh": "更新",
  "debug.loading": "読み込み中…",
  ...
  "debug.previewTitle": "プレビュー / 透過取り込み",
  ...
  "debug.latencySpeechToPaint": "発話開始→初回字幕",
  "debug.latencyIpcToPaint": "受信→初回字幕",
  "debug.latencyPaintToVisible": "字幕確定→Syphon表示",
  "debug.latencyConvert": "変換所要時間",
  ...
  "debug.testCaptionHint":
    "入力したテキストを現在の字幕ソースとして発行し、透過取り込みと表示経路を確認します。",
...
const en: Record<MessageKey, string> = {
  ...
  "brand.caption": "Speech to live captions",
  "sidebar.eyebrow": "BROADCAST CONSOLE",
  "sidebar.title": "Start captioning",
  "sidebar.description":
    "Pick a microphone and press Start to turn Japanese speech into English captions.",
  "sidebar.menu": "Main menu",
  "sidebar.live": "Live",
  "sidebar.style": "Caption style",
  "sidebar.dictionary": "Custom dictionary",
  ...
  "live.title": "Captions",
  "live.lead":
    "Choose a microphone and press Start. Detailed tuning lives under Advanced settings.",
  "live.openOverlay": "Open transparent capture ↗",
  "live.hideOverlay": "Hide transparent capture",
  "live.nativeAlwaysOn": "Syphon / Spout2 always publishing",
  "live.outputToSyphon": "Outputting to Syphon",
  "live.outputToSpout2": "Outputting to Spout2",
  "live.outputToTransparentWindow": "Outputting to transparent capture",
  "live.outputStatusHint": "Captions are not drawn in this window.",
  "live.openTransparentCapture": "Open transparent capture ↗",
  "live.hideTransparentCapture": "Hide transparent capture",
  "live.openStyleEditor": "Open caption style ↗",
  "live.start": "Start captioning",
  "live.stop": "Stop",
  "live.startBlockedModels": "Captioning starts after ASR models finish preparing",
  "live.startBlockedServices": "Captioning starts after recognition services are ready",
  "live.startBlockedWebSpeech": "Web Speech is not available in this runtime",
  "live.previewEyebrow": "LIVE PREVIEW",
  ...
  "live.pipelineEyebrow": "PIPELINE",
  "live.pipelineTitle": "Current processing",
  ...
  "live.pipelineSummaryAzookey":
    "Parapper recognizes speech, AzooKey converts it to kanji, then it is translated to English.",
  "live.pipelineSummaryRaw":
    "Parapper recognition is used as the caption source without conversion.",
  "live.pipelineSummaryWebSpeech": "Browser Web Speech API recognizes speech (for debugging).",
  "live.latestEyebrow": "LATEST CAPTION",
  "live.latestTitle": "Latest transcription",
  "settings.eyebrow": "CONFIGURATION",
  "settings.title": "App settings",
  "settings.lead": "Everyday options are separate from advanced tuning.",
  "settings.panes": "Settings sections",
  "settings.everyday": "Everyday",
  "settings.advanced": "Advanced",
  "settings.everydayLead":
    "Check these before you go live. Models and audio tuning live under Advanced.",
  "settings.advancedLead": "Models, audio processing, and output details.",
  "settings.customDictionaryTitle": "Custom dictionary",
  "settings.customDictionaryDescription": "Register readings and words for kana-kanji conversion.",
  ...
  "customDictionary.searchWord": "Search words",
  ...
  "customDictionary.delete": "Delete",
  "customDictionary.cancel": "Cancel",
  "customDictionary.save": "Save dictionary",
  "customDictionary.saving": "Saving…",
  "customDictionary.empty": "No words have been registered.",
  "customDictionary.noResults": "No words match the search filters.",
  "customDictionary.saved": "Custom dictionary saved.",
  "customDictionary.loadFailed": "Could not load the custom dictionary.",
  "customDictionary.saveFailed": "Could not save the custom dictionary.",
  "customDictionary.importCsv": "Import CSV (append)",
  "customDictionary.exportCsv": "Export CSV",
  "customDictionary.imported": "Appended {count} CSV entries. Save to apply them to conversion.",
  "customDictionary.exported": "Exported {count} entries to CSV.",
  "customDictionary.importFailed":
    "Could not read CSV. Check that it has Reading and Word columns.",
  "settings.everydayCaptureTitle": "Speech and recognition",
  "settings.everydayOutputTitle": "Caption output",
  "settings.backendTitle": "Inference endpoint",
  ...
  "settings.azooSystemDictionary": "AzooKey system dictionary (custom path/URL)",
  "settings.azooSystemDictionaryHint":
    "A local Dictionary directory, or an HTTPS .tar.gz URL. URLs are cached under app data.",
  "settings.azooSystemDictionarySource": "AzooKey system dictionary",
  "settings.azooSystemDictionarySourceHint":
    "Choose built-in auto-fetch, the official archive URL, or a custom local/HTTPS path.",
  "settings.azooSystemDictionaryBuiltin": "Built-in (auto-fetch on first capture)",
  "settings.azooSystemDictionaryOfficial": "Official azooKey_dictionary_storage (HTTPS)",
  "settings.azooSystemDictionaryCustom": "Custom path / HTTPS URL",
  ...
  "settings.autoGainControlOn": "Enabled (recommended)",
  "settings.overlayEyebrow": "OVERLAY LAYOUT",
  "settings.overlayTitle": "Caption layout",
  "settings.width": "Shared output width (px)",
  "settings.height": "Shared output height (px)",
  "settings.windowX": "Caption display window X (px)",
  "settings.windowY": "Caption display window Y (px)",
  ...
  "settings.nativeOutputHint":
    "Starts Syphon on macOS or Spout2 on Windows. Off by default; use the caption display window when disabled.",
  ...
  "message.overlayOpenFailed": "Could not open the caption display window.",
  "message.transparentOpenFailed": "Could not open the caption display window.",
  "message.styleEditorOpenFailed": "Could not open the caption style window.",
  "message.customDictionaryOpenFailed": "Could not open the custom dictionary window.",
  ...
  "model.azookey.label": "AzooKey Rust (dictionary, built in)",
  "model.azookey.description":
    "Runs AzooKey LOUDS dictionaries, connection costs, and user dictionaries through the Rust Viterbi converter (no neural model).",
  "model.azookey.artifact":
    "Built-in dictionary / Dictionary directory from azooKey_dictionary_storage",
  "model.zenzXsmall.label": "AzooKey Zenzai v3.2 xsmall",
  "model.zenzXsmall.description":
    "Official AzooKey neural conversion (Zenzai). Low-latency xsmall GGUF. Download it once from Model install.",
  "model.zenzSmall.label": "AzooKey Zenzai v3.2 small",
  "model.zenzSmall.description":
    "Official AzooKey neural conversion (Zenzai). Quality-focused small GGUF. Download it once from Model install.",
  "model.zenzV2.label": "AzooKey Zenzai v2 Q5_K_M",
  ...
  "debug.enableHint":
    "Open Debug info under Advanced settings to watch ASR / normalizer / translator stages live. Open state and verbose logging are saved locally so you can leave debug mode on during development.",
  ...
  "debug.previewTitle": "Preview / transparent capture",
  ...
  "debug.autoGainControl": "Auto gain",
  "debug.on": "on",
  "debug.off": "off",
  ...
  "debug.latencySpeechToPaint": "Speech start → first caption",
  "debug.latencyIpcToPaint": "IPC receive → first caption",
  "debug.latencyPaintToVisible": "Caption paint → Syphon present",
  "debug.latencyConvert": "Convert duration",
  ...
  "debug.testCaptionHint":
    "Publish the entered text as the current caption source to verify transparent capture and the display path.",
