...
const ja = {
  ...
  "settings.transparentDetail":
    "設定で Syphon / Spout2 を有効にすると画面外の native-renderer が字幕を配信します。無効時や非対応環境では「字幕表示」ウィンドウを開き、通常のデスクトップウィンドウとして確認するか OBS の Window Capture で取り込んでください。",
...
const en: Record<MessageKey, string> = {
  ...
  "settings.transparentDetail":
    "Enable Syphon/Spout2 in settings to publish captions from an off-screen native-renderer. When disabled or unsupported, open the caption display window as a normal desktop window, or capture it with OBS Window Capture.",
