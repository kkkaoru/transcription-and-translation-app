//! Link the crate-vendored `Syphon.framework` for macOS builds.
//!
//! `syphon-rs` 0.1.1 looks for a system or crate-vendored framework. This
//! crate carries the universal Metal build used by the Native application.
...
fn main() {
    ...
    let framework_dir = manifest_dir.join("frameworks");
